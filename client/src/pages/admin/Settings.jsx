...
const Settings = () => {
  return (
    <div className="space-y-8">
        ...
        <div className="bg-white p-8 rounded-lg shadow-sm border border-gray-100 space-y-6">
          ...
          <div className="space-y-4">
            <div className="space-y-1">
              ...
              <input type="text" className="w-full bg-gray-50 border border-gray-100 rounded-lg py-4 px-6 focus:outline-none focus:border-primary font-bold" defaultValue="Kinki Bazar" />
            </div>
            <div className="space-y-1">
              <label className="text-xs font-black uppercase tracking-widest text-gray-400 ml-1">Support Email</label>
              <input type="email" className="w-full bg-gray-50 border border-gray-100 rounded-lg py-4 px-6 focus:outline-none focus:border-primary font-bold" defaultValue="support@kinkibazar.com" />
            </div>
          </div>
        </div>
      ...
      <div className="bg-accent p-8 rounded-lg text-white flex flex-col md:flex-row justify-between items-center space-y-6 md:space-y-0">
        <div>
        ...
        <div className="flex space-x-4">
          <button className="px-8 h-14 rounded-lg bg-white/10 hover:bg-white/20 font-bold transition-all">Discard</button>
          <button className="px-10 h-14 rounded-lg bg-primary hover:bg-primary-dark font-black shadow-xl shadow-primary/20 transition-all">Save Config</button>
        </div>
      </div>
    </div>
  );
